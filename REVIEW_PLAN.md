...
- [x] P5：交付問題、驗證、發布清單、三項放行判定與獨立學習成效證據狀態
- [x] P6：啟用 GitHub Pages，於正式 HTTPS URL 重跑完整瀏覽器流程
...
| L GitHub 發布與重現性 | Git 邊界、候選公開檔案 | 混入父庫／私人資料、授權不清 | tracked 清單、歷史範圍、fresh clone、正式 Pages | PASS |
